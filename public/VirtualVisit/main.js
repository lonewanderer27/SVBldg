const homeUrl = "/VirtualVisit/SVBldg.sh3d";
...
viewHome(
  ...
  onprogression, // Callback called while loading
  {
    ...
    level: "2nd Floor", // Uncomment to select the displayed level, default level if missing */
    selectableLevels: ["2nd Floor"], // Uncomment to choose the list of displayed levels, no select component if empty array */
